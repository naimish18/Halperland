...
<c:set var="id" value="<%= u_id.getUserId() %>" scope="session"></c:set>
    ...
    <div class="container-fluid px-0 py-0">
        <img id="faq_banner" src="<c:url value="/resources/images/group-16_2.png"></c:url>" alt="">
    </div>

    <div id="price_include" style="background-color: #FFFFFF;">
        <div style="padding-top: 70px;position: relative;">
            <p id="price_title" style="font-size: 35px;text-align: center;font-family: Roboto;font-size: 36px;"><b>Contact us</b></p>
        ...
        <div class="container price_include_card">
            <div class="row">
                <div class="col-md-6 col-lg-4 contact_card">
                    <img id="contact_img" src="<c:url value="/resources/images/forma-1_2.png"></c:url>" alt="">
                    <p id="contact_txt" style="margin-top: 20px;">1111 Lorem ipsum text 100,</p>
                    <p id="contact_txt" style="padding: 0px;">Lorem ipsum AB</p>
                    
                </div>
                <div class="col-md-6 col-lg-4 contact_card" >
                    <img id="contact_img" src="<c:url value="/resources/images/phone-call.png"></c:url>" alt="">
                    <p id="contact_txt" style="margin-top: 20px;">+49 (40) 123 56 7890</p>
                    <p id="contact_txt" style="padding: 0px;">+49 (40) 987 56 0000</p>

                </div>
                <div class="col-md-6 col-lg-4 contact_card" >
                    <img id="contact_img" src="<c:url value="/resources/images/vector-smart-object.png"></c:url>" alt="" style="margin-top: 5px;">
                    <p id="contact_txt" style="margin-top: 28px;">info@helperland.com</p>
    ...
    <div class="container" style="border-top: 1px solid #E1E1E1;">
      <p style="font-size: 28px;font-family: 'Roboto',sans-serif;font-weight: bold;color: #4F4F4F;text-align: center;margin-top: 50px;">Get in touch with us</p>
      <div id="form_main_div">
        <form action="savecontact" method="post">
          <div id="form_sub_div">
            <input type="text" class="form-control" name="Name" id="f_name" placeholder="First name" required="required">
            <input type="text" class="form-control" id="l_name" placeholder="Last name" required="required">
          </div>
          ...
          <div id="form_sub_div">
            <div id="phone_num_div">
              ...
              <div style="width: fit-content;display: inline;margin-left: -5px;">
                <input type="tel" class="form-control" name="PhoneNumber" id="phone_num" placeholder="Mobile number" required="required">
              </div>
            </div>
          ...
          <div id="subject">
            <select id="subject_menu" class="form-select" name="Subject" id="">
          ...
          <button id="submit_btn" type="submit" class="btn rounded-pill" style="background-color: #29626D;padding: 11px 50px;">Submit</button>
        </form>
      </div>
    </div>
